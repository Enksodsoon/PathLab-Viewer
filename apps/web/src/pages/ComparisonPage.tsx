...
export function ComparisonPage() {
  ...
  return <div className="comparison-shell">
    ...
    {!correction && !grouping && hasMatchedMap && hasPendingLandmarkValidation && !registrationPending ? <div className="comparison-notice" role="note" aria-label="Alignment validation pending"><strong>Local structural maps are available.</strong> Matched regions passed alternative-fragment and withheld patch checks, but anatomical error has not been measured against independent landmarks.</div> : null}
