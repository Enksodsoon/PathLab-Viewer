...
- Production stress runs only in the 02:00–05:00 ICT window, with no active real Classroom, a verified backup/restore drill, rollback release, synthetic fixtures, and fail-closed cleanup.
